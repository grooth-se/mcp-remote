...
STANDARD_GRADES = [
    ...
    (
        ...
        "Structural steel EN 10025",
        {
            ...
            "htc_natural_convection": {
                ...
                "units": "W/(m²·K)",
                "deps": "temperature",
                "data": {"temperature": [20, 200, 400, 600, 800], "value": [5, 8, 12, 18, 25]},
    ...
    (
        "AISI 4330V",
        "Vanadium-modified NiCrMo steel",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        "A182 F22",
        "CrMo pressure vessel steel (2.25Cr-1Mo)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        "A182 F11",
        "CrMo pressure vessel steel (1.25Cr-0.5Mo)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        "A182 F5",
        "CrMo pressure vessel steel (5Cr-0.5Mo)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        ...
        None,
    ),  # No transformation for austenitic
    (
        "316",
        "Austenitic stainless steel (16Cr-10Ni-2Mo)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        "2205",
        "Duplex stainless steel (22Cr-5Ni-3Mo)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        "2507",
        "Super duplex stainless steel (25Cr-7Ni-4Mo)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        "300M",
        "Ultra-high strength steel (Si-Cr-Mo-V)",
        {
            "thermal_conductivity": {
                "type": "curve",
                "units": "W/(m·K)",
    ...
    (
        ...
        "Nickel-chromium superalloy",
        {
            "thermal_conductivity": {
                ...
                "deps": "temperature",
                "data": {
                    "temperature": [20, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000],
        ...
        None,
    ),  # No transformation for nickel alloys
    (
        "Inconel 718",
...
def seed_standard_grades() -> dict:
    ...
    for designation, description, properties, transformation_temps in STANDARD_GRADES:
        ...
        existing = SteelGrade.query.filter_by(
            designation=designation, data_source=DATA_SOURCE_STANDARD
        ).first()
        ...
        try:
            # Create steel grade
            grade = SteelGrade(
                designation=designation, data_source=DATA_SOURCE_STANDARD, description=description
            )
            ...
            if transformation_temps:
                diagram = PhaseDiagram(steel_grade_id=grade.id, diagram_type=DIAGRAM_TYPE_CCT)
...
def seed_standard_compositions() -> dict:
    ...
    """
    results = {"compositions_created": 0, "compositions_skipped": 0, "errors": []}
...
def get_grade_by_designation(designation: str, data_source: str = DATA_SOURCE_STANDARD):
    ...
    SteelGrade or None
    """
    return SteelGrade.query.filter_by(designation=designation, data_source=data_source).first()
