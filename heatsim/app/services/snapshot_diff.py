...
class SnapshotDiffService:
    ...
    def summary_comparison(snap1, snap2):
        ...
        if (
            snap1.predicted_hardness_surface is not None
            or snap2.predicted_hardness_surface is not None
        ):
        ...
        if (
            snap1.predicted_hardness_center is not None
            or snap2.predicted_hardness_center is not None
        ):
