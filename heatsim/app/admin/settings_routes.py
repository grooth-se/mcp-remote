...
SETTINGS_SCHEMA = [
    {
        ...
        "settings": [
            {
                "key": "comsol_path",
                "label": "COMSOL Installation Path",
                "type": "string",
                "default": "/usr/local/comsol",
    ...
    },
    {
        ...
        "settings": [
            ...
            {
                "key": "simulation_timeout_seconds",
    ...
    if request.method == "POST":
        for group in SETTINGS_SCHEMA:
            for s in group["settings"]:
                ...
                SystemSetting.set(key, value, value_type=s["type"], description=s["description"])
