...
from app.models import AuditLog, Simulation, SteelGrade, User, WeldProject, admin_required
...
def create_user():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        AuditLog.log(
            "create_user", resource_type="user", resource_id=user.id, resource_name=user.username
        )
...
def edit_user(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        AuditLog.log(
            "update_user", resource_type="user", resource_id=user.id, resource_name=user.username
        )
...
def delete_user(id):
    ...
    db.session.commit()
    AuditLog.log("delete_user", resource_type="user", resource_name=username)
